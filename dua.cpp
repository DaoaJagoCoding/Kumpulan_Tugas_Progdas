...
int main (){
    ...
    cout << "Nilai distance atau diameternya adalah "<<fixed<<setprecision(4)<<Distance(x1,x2,y1,y2)<<endl;
    cout << "Nilai radiusnya adalah "<<fixed<<setprecision(4)<<Radius(x1,x2,y1,y2)<<endl;
    cout << "Nilai circumference adalah "<<fixed<<setprecision(4)<<Circumference(x1,x2,y1,y2)<<endl;
    cout << "Nilai luas area adalah "<<fixed<<setprecision(4)<<Area(x1,x2,y1,y2)<<endl;
